#!/usr/bin/env python3
"""
Web Browser - A simple, modern browser with dark mode, incognito mode and tracking features
"""
import sys
import os
import re
...
# Database Manager for tracking visits, IPs, and firewall
...
# Browser Tab class to display web content
...
class WebBrowser(QMainWindow):
    def __init__(self, incognito=False):
        ...
        # Setup window
        window_title = "Web Browser" + (" (Incognito)" if incognito else "")
